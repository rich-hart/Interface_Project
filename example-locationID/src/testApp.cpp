...
unsigned long EYE_CAMERA_ID = 639827968; // Using port A (MacMini Mid 2011) for this example
unsigned long FRONT_CAMERA_ID = 639893504;
//--------------------------------------------------------------
void testApp::setup(){
...
void testApp::draw(){
    ...
    else ofDrawBitmapString("No PS3Eye found at "+ofToString(EYE_CAMERA_ID), 20,20);
}
